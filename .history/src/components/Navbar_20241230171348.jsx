...
import icon from "../assets/olx-seeklogo.png";
    ...
    <>
      <div className="flex  p-4 bg-slate-100 shadow-md justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <div className="hidden md:flex border-2 border-spacing-1 w-64 p-2 border-black ml-6 bg-white">
        ...
        <div className="w-28 flex h-12 p-2 ml-6 cursor-pointer rounded-full border border-yellow-500 items-center justify-center">
