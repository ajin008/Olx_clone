    ...
    <>
      <div className="flex  p-4 bg-slate-100 shadow-md justify-between items-center">
        ...
        {isAuthenticated ? (
          ...
          //   <div className="w-10 h-10 rounded-full cursor-pointer flex items-center justify-center bg-gray-200">
          //     <User size={24} color="#000" />
          //   </div>
          //   <div className="absolute top-12 right-0 bg-white shadow-md rounded-md hidden group-hover:block">
          //     <ul>
          //       <li
          //         className="p-5 cursor-pointer text-red-500 hover:bg-gray-100"
          //         onClick={logout}
          //       >
          //         Logout
          //       </li>
          ...
          <div className="relative group">
            <div
              className="w-10 h-10 rounded-full cursor-pointer flex items-center justify-center bg-gray-200"
